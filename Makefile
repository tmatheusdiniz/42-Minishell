...
SRCS = 	$(SRC_DIR)/core/main.c $(SRC_BUILT)/echo.c $(SRC_BUILT)/pwd.c $(SRC_BUILT)/cd.c $(SRC_BUILT)/env.c \
		...
		$(SRC_DIR)/utils/free.c $(SRC_DIR)/parsing/parsing.c $(SRC_DIR)/tokenization/split_token.c  $(SRC_DIR)/tokenization/tokenizer.c \
		$(SRC_DIR)/tree/tree.c $(SRC_DIR)/tree/tree_utils.c 
OBJS = $(SRCS:.c=.o)
